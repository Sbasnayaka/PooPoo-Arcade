...
export default function Home() {
  return (
    <main className="min-h-screen relative bg-deep-brown overflow-hidden flex flex-col">
      {/* Header Layer - Above Physics */}
      <div className="z-20 relative pt-12 text-center pointer-events-none">
        <h1 className="text-6xl md:text-9xl font-display text-warm-tan drop-shadow-[6px_6px_0px_#000] rotate-2 inline-block">
          PooPoo Arcade
        </h1>
        <p className="text-xl font-body text-cream mt-4 bg-mid-brown inline-block px-4 py-1 rotate-[-1deg] border-2 border-black shadow-[4px_4px_0px_#000]">
      ...
      <div className="absolute bottom-4 left-4 text-rust font-irony animate-bounce z-10 pointer-events-none">
